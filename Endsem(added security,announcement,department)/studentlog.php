...
<body>
	...
	<form method="post" action="allready.php">
		<div class="input-g">
			...
			<input type="text" name="reg" maxlength="6" pattern="[0-9]{6}" id="reg" required>
		</div>
		<div class="input-g">
		...
		<div class="input-g">
			<button type="button" name="login" onclick="encry();" class="btn">Login</button>
		</div>
		<p>
		   ...
		   function encry()
		   {
			   ...
			   allready.onreadystatechange = function ()
              {
			   ...
			   var jsonData = $.ajax({
				...
				window.location.href = "ticketgrant.php?"+jsonData.ciquery;	
		   }
		</script>
	</form>
</body>
